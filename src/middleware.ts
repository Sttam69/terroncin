...
export async function middleware(request: NextRequest) {
  ...
  // Protect root path (Lobby) and other private routes
  ...
  const isPublicRoute = request.nextUrl.pathname === '/privacidad' || request.nextUrl.pathname === '/terminos'
  ...
  // Redirect to Lobby if logged in user tries to access login/register
